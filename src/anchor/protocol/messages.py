...
REQUEST_SCHEMAS: Final[dict[str, Schema]] = {
    ...
    "schedule.skip": EMPTY,
    "schedule.list": EMPTY,
    "schedule.show": Schema(id=Field(str)),
    "schedule.create": Schema(
        name=Field(str),
        profile=Field(str),
        days=Field(list, item_kind=str),
        start=Field(str),
        end=Field(str),
        level=Field(str, required=False, default=None, choices=_LEVELS),
        valve=Field(str, required=False, default=None, choices=_VALVES),
    ),
    "schedule.edit": Schema(
        id=Field(str),
        name=Field(str, required=False, default=None),
        profile=Field(str, required=False, default=None),
        days=Field(list, required=False, default=None, item_kind=str),
        start=Field(str, required=False, default=None),
        end=Field(str, required=False, default=None),
        level=Field(str, required=False, default=None, choices=_LEVELS),
        valve=Field(str, required=False, default=None, choices=_VALVES),
        enabled=Field(bool, required=False, default=None),
    ),
    "schedule.delete": Schema(id=Field(str)),
